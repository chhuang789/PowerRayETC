...
class PMBus:
    ...
    def getFans(self):
        self.fans = self._decodePMBus(self._readWordPMBus(0x90))
        return self.fans
...
if __name__ == "__main__":
    ...
    print("Fan Speed: " + str(DRQ.getFans()))
    ...
    print("Output Power: " + str(DRQ.getPowerOut(True)) + "\n\n") #False is caclulated from given values of current and voltage while True gets values
